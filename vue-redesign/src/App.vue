  ...
  <div id="app">
    ...
    <main>
      ...
      <div class="has-text-centered">
        ...
        <sup>Built with</sup>
        <br>
        <a href="https://vuejs.org" rel="noreferer" target="_blank" aria-label="Visit the Vue homepage to find out more">
        ...
        <a href="https://github.com" rel="noreferer" target="_blank" aria-label="Visit the GitHub homepage to find out more">
          <svg viewBox="0 0 128 128" width="4%">
